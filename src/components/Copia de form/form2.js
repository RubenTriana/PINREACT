        ...
        <div className="col colForm p-5 mx-4">
          ...
          <form className="formulary w-100" onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-2">
              ...
              <input type="text" className=" form-control shadow-none  " id="nameForm" autoComplete="off" {...register("nombre")} />
            ...
            <div className="mb-2">
              ...
              <input type="email" className="form-control shadow-none" id="emailForm" aria-describedby="emailHelp" autoComplete="off" {...register("correo")} />
            ...
            <div className="mb-2">
              ...
              <input type="number" className="form-control shadow-none" id="telForm" autoComplete="off"  {...register("telefono")} />
              <p className="error"> {errors.telefono?.message}</p>
            </div>
            <div className="mb-2">
              <label htmlFor="textMessage" className="form-label">Comentario</label>
              <textarea type="text" className="form-control shadow-none" id="messageForm" rows={3} autoComplete="off" {...register("mensaje")} />
            </div>
